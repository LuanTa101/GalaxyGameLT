class lvl1 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("fish", "fishBlue_fall.png");
        // Animation
        ...
        if (this.deadEnemies === this.numEnemies) {
            ...
            if (this.levelCompleteSoundPlayed) {
                ...
                this.time.delayedCall(4000, () => {
                    this.scene.start("blackScreen", { levelText: "Level 2", nextScene: "second" });
                    this.playerHealth = 3;
                    this.deadEnemies = 0;
                });
            }
    ...
    createFishEnemies(index) {
        ...
        this.time.delayedCall(1000, () => {
            let fishEnemy = this.add.follower(this.curve, initX, initY, "fish");
            ...
            console.log("Fish Enemies:", this.my.sprite.fishEnemies);
        });
    }
