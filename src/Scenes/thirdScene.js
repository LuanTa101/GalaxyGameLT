class lvl3 extends Phaser.Scene {
    ...
    preload() {
        ...
        document.getElementById('description').innerHTML = '<h2>thirdScene.js<br>Space - shoot<br>A - move left // D - move right</h2>'
    } 
    ...
    create() {
        ...
        this.restartText.setVisible(false); // Initially hide the text
        ...
        if (this.deadEnemies === this.numEnemies) {
            ...
            if (this.levelCompleteSoundPlayed) {
                ...
                this.time.delayedCall(4000, () => {
                    this.scene.start("blackScreen", { levelText: "Well Played", nextScene: "title" });
                    this.playerHealth = 3;
                    this.deadEnemies = 0;
                });
            }
    ...
    createFishEnemies(index) {
        ...
        this.time.delayedCall(1000, () => {
            let fishEnemy = this.add.follower(this.curve, initX, initY, "frog");
